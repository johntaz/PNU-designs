# -----------------------------------------------------------------------------
# PROGRAM NAME:  timeConditionalPS_Time
# AUTHOR:        John Tazare
# NOTES:        Estimate the time-conditional propensity score for PNU analysis
#
# REQUIRES: Time exSets to be run and exSetsInfo (dataset of characteristics 
...
# Fit conditional logistic regression model for each of the time exposure sets 
