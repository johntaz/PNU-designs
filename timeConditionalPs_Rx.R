# -----------------------------------------------------------------------------
# PROGRAM NAME:  timeConditionalPS_Rx
# AUTHOR:        John Tazare
# NOTES:        Estimate the time-conditional propensity score for PNU analysis
#
# REQUIRES: Rx exSets to be run and exSetsInfo (dataset of characteristics 
...
# Fit conditional logistic regression model for each of the rx exposure sets 
